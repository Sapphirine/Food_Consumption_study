...
$file_name="fbs_cluster_2003.csv";
...
<p align="center"><h1>2003 Year Food Consumption Result</h1></p>
</div>
 ...
 myChart.setOption(option);
	...
	<div class="copy-right">
      ...
      <p class="grid1" >
       <a href="diqiu2002.php"> <button type="button" class="btn btn-lg btn-info" >previous year</button></a>
        <a href="diqiu2004.php"><button type="button" class="btn btn-lg btn-info" >next year</button></a>
      </p>
