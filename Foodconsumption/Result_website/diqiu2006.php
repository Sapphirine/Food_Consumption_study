...
$file_name="fbs_cluster_2006.csv";
...
<p align="center"><h1>2006 Year Food Consumption Result</h1></p>
</div>
 ...
 myChart.setOption(option);
	...
	<div class="copy-right">
      ...
      <p class="grid1" >
       <a href="diqiu2005.php"> <button type="button" class="btn btn-lg btn-info" >previous year</button></a>
        <a href="diqiu2008.php"><button type="button" class="btn btn-lg btn-info" >next year</button></a>
      </p>
