...
$file_name="fbs_cluster_2002.csv";
...
<p align="center"><h1>2002 Year Food Consumption Result</h1></p>
</div>
 ...
 myChart.setOption(option);
	...
	<div class="copy-right">
      ...
      <p class="grid1" >
       <a href="diqiu2001.php"> <button type="button" class="btn btn-lg btn-info" >previous year</button></a>
        <a href="diqiu2003.php"><button type="button" class="btn btn-lg btn-info" >next year</button></a>
      </p>
