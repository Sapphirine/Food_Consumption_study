...
$file_name="fbs_cluster_2005.csv";
...
<p align="center"><h1>2005 Year Food Consumption Result</h1></p>
 ...
 myChart.setOption(option);
	...
	<div class="copy-right">
      ...
      <p class="grid1" >
       <a href="diqiu2004.php"> <button type="button" class="btn btn-lg btn-info" >previous year</button></a>
        <a href="diqiu2006.php"><button type="button" class="btn btn-lg btn-info" >next year</button></a>
      </p>
